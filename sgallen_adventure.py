...
"start": ["Hello and welcome to Sam's game! Choose an option. ", "Play! ", "choice", "Quit. ", "quit"], 
 ...
 "sword": ["Now that you have a sword, you kill some animals and eat some food to replenish your hunger. Where will you go from here?", "The village from earlier. ", "villageTwo", "A nearby ravine. ", "ravine"], 
 ...
 "keep": ["Just what I like to see. After some more exploration, you find an Ancient City. If I'm being honest, I'd leave. This place is too dangerous. But what will you do? ", "Leave!", "leave", "Explore it!", "explore"], 
